"use client"
import { SelectOptions } from '@/components/dashboard/Select'
...
import { AddProduct, getCategories } from '@/actions/productsAction'
...
export default function ADDpages() {
  ...
  const handleSubmit = async (formData: FormData) => {
    ...
    // Create a new object with the correct types for price and stock
    const parsedData = {
    ...
    <>
      ...
      <form action={handleSubmit} className='grid my-5 md:p-7 p-3 grid-cols-3 gap-3 items-center'>
        ...
        <div className='gap-1 grid'>
          ...
          <Input name="name" className='text-xs' placeholder='Product Name' />
        ...
        <div className='gap-1 grid'>
          ...
          <Input name="price" type="number" className='text-xs' placeholder='Product Price' />
          <div className='error text-red-500 h-2 text-xs'>
        ...
        <div className='gap-1 grid'>
          ...
          <Input name="stock" type="number" className='text-xs' placeholder='Product Stock' />
          <div className='error text-red-500 h-2 text-xs'>
        ...
        <div className='gap-1 grid col-span-3'>
          ...
          <Textarea name="description" className='text-xs' placeholder='Product Description' />
          <div className='error text-red-500 h-2 text-xs'>
