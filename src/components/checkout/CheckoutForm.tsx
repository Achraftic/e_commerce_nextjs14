...
export default function CheckoutForm() {
  ...
  return (
    <form action={CreateCommande} className="space-y-6  flex-1 p-4 ">
      ...
      <h2 className="text-2xl  font-semibold text-zinc-800 dark:text-zinc-100">Shipping Information</h2>
      ...
      {/* Payment Information */}
      <h2 className="text-2xl font-semibold text-zinc-800 dark:text-zinc-100">Payment Information</h2>
